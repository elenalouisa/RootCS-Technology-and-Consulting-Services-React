        ...
        <div className="pricing14-section-title">
          ...
          <div className="pricing14-content">
            <h2>
              {props.heading1 ?? (
                <Fragment>
                  <h2 className="pricing14-text083 thq-heading-2">
                    Pricing plan
                  </h2>
                </Fragment>
              )}
              ...
              <div className="pricing14-price">
                <div className="pricing14-price01">
                  ...
                  <h3>
                    {props.plan1Price ?? (
                      <Fragment>
                        <h3 className="pricing14-text098 thq-heading-3">
                          $99/month
                        </h3>
                      </Fragment>
                    )}
                  ...
                  <p>
                    {props.plan1Yearly ?? (
                      <Fragment>
                        <p className="pricing14-text061 thq-body-large">
                          $999/year
                        </p>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price02">
                <div className="pricing14-price03">
                  ...
                  <h3>
                    {props.plan2Price ?? (
                      <Fragment>
                        <h3 className="pricing14-text095 thq-heading-3">
                          $199/month
                        </h3>
                      </Fragment>
                    )}
                  ...
                  <p>
                    {props.plan2Yearly ?? (
                      <Fragment>
                        <p className="pricing14-text076 thq-body-large">
                          $1999/year
                        </p>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price04">
                <div className="pricing14-price05">
                  ...
                  <h3>
                    {props.plan3Price ?? (
                      <Fragment>
                        <h3 className="pricing14-text093 thq-heading-3">
                          $299/month
                        </h3>
                      </Fragment>
                    )}
                  ...
                  <p>
                    {props.plan3Yearly ?? (
                      <Fragment>
                        <p className="pricing14-text072 thq-body-large">
                          $2999/year
                        </p>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price06">
                <div className="pricing14-price07">
                  ...
                  <span>
                    {props.plan1Yearly1 ?? (
                      <Fragment>
                        <span className="pricing14-text086 thq-body-large">
                          or $20 monthly
                        </span>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price08">
                <div className="pricing14-price09">
                  ...
                  <h3>
                    {props.plan2Price1 ?? (
                      <Fragment>
                        <h3 className="pricing14-text056 thq-heading-3">
                          $299/yr
                        </h3>
                      </Fragment>
                    )}
